...
for tm in ['f', 's']:
    ...
    while True:
        ...
        response = requests.get(f"https://www.wikiaves.com.br/getRegistrosJSON.php?tm={tm}&t=c&s=10434&c=3550308&p={page}", headers=headers)
...
df.to_csv(os.path.join("wikiaves_data", "wikiaves_grid.csv"), index=False)
